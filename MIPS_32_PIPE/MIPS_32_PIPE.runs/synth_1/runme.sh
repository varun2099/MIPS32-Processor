...
HD_PWD='C:/Users/varun/MIPS_32_PIPE/MIPS_32_PIPE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_32_PIPE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPS_32_PIPE.tcl
